  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.roadmap}>
        ...
        <svg className={styles.roadmapBg} viewBox="0 0 1395 772" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={styles.footer}>
        <a className="arrow-link" href="http://roadmap.getleon.ai" target="_blank" rel="noreferrer">
